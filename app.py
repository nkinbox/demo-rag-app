...
def cleanChunk(text):
    prompt = (
        'You are a compliance document cleaner.\n'
        '\n'
        'Your task is to remove **only garbage or layout artifacts** from the following text extracted from a PDF.\n'
        '\n'
        'Do not change the wording, structure, or meaning of the content.\n'
        '\n'
        'You may remove:\n'
        '- Page numbers like "Page 5", "Page 1 of 3"\n'
        '- Repeating headers or footers (like "ASCI Code of Conduct", etc.)\n'
        '- Extra line breaks, tabs, or inconsistent spacing\n'
        '- Section separators (like lines of dashes or underscores)\n'
        '- Broken words or garbled symbols caused by OCR\n'
        '\n'
        'Do NOT:\n'
        '- Rephrase or paraphrase\n'
        '- Add or summarize anything\n'
        '- Change grammar or sentence order\n'
        '\n'
        'Here is the text:\n'
        '---\n'
        f'{text}\n'
        '---\n'
        '\n'
        'Return only the cleaned version of the input text.\n'
        '\n'
        'Do not include any extra explanation, markdown formatting, or assistant-style introductions in your response.\n'
    )
    openai = OpenAI()
